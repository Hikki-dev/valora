...
class OnboardingContent {
  ...
  static List<OnboardingContent> get features => [
        OnboardingContent(
          ...
          description:
              'The dashboard shows every platform you own games on, with live valuations and a grand total that updates automatically.',
          bulletPoints: [
        ...
        OnboardingContent(
          ...
          description:
              'Search by title or scan a barcode. Valora fetches the cover art, metadata and current market price automatically.',
          bulletPoints: [
        ...
        OnboardingContent(
          ...
          description:
              'Every game shows loose, complete and sealed values from real eBay sales data. Set your condition once and Valora always shows the right price.',
          bulletPoints: [
        ...
        OnboardingContent(
          ...
          description:
              'Whether it\'s PlayStation, Steam, Epic, or Nintendo, Valora organizes your library across all digital and physical platforms.',
          bulletPoints: [
        ...
        OnboardingContent(
          ...
          description:
              'Generate beautiful snapshots of your collection value and share them with the world.',
          bulletPoints: [
        ...
        OnboardingContent(
          ...
          description:
              'Import your entire library from Steam, Playstation, and Epic in one tap. Valora handles the metadata and valuation automatically.',
          bulletPoints: [
