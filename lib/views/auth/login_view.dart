...
class _LoginViewState extends ConsumerState<LoginView> {
  ...
  Widget build(BuildContext context) {
    ...
    final containerBg = isDark ? Colors.black.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.85);
    ...
    final backgroundImage = isDesktop 
        ? 'assets/icon/batman.jpg' 
        : 'assets/icon/Spalsh.webp';
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          ).animate().fadeIn(duration: 800.ms).scale(begin: const Offset(1.1, 1.1), end: const Offset(1.0, 1.0), duration: 2.seconds, curve: Curves.easeOut),
            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.white, // Locked to white for high contrast on image
                        letterSpacing: -2.0,
                      )
                    ...
                    AnimatedSwitcher(
                      ...
                      child: Text(
                        _isLogin ? 'COLLECTION VALUATION ENGINE' : 'JOIN THE ARCHIVE', 
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                 ...
                                 Padding(
                                   ...
                                   child: Text('OR', style: TextStyle(color: textColor.withValues(alpha: 0.5), fontSize: 12, fontWeight: FontWeight.bold)),
                                 ),
                                 Expanded(child: Divider(color: borderColor)),
                              ],
                            ),
                            ...
                            OutlinedButton.icon(
                              ...
                              label: Text(_isLogin ? 'Continue with Google' : 'Join with Google'),
                  ...
                  ).animate().fadeIn(delay: 400.ms).scale(begin: const Offset(0.9, 0.9), end: const Offset(1.0, 1.0)),
