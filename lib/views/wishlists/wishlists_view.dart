            ...
            child: Row(
              children: [
                Hero(
                  ...
                  child: Container(
                    ...
                    child: item.coverUrl != null && item.coverUrl!.isNotEmpty
                        ...
                        : const Center(child: Icon(Icons.videogame_asset, color: Colors.white24)),
                  ),
                ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1),
                        ),
                      ),
                      ...
                      Row(
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('TARGET', style: TextStyle(color: isDark ? Colors.white38 : Colors.black38, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
                              Text(
                                item.targetPrice != null ? currency.format(item.targetPrice!) : 'ANY DEAL',
                                style: TextStyle(
                            ...
                            children: [
                              if (item.currentPrice != null && item.targetPrice != null && item.currentPrice! <= item.targetPrice!)
                                 Container(
                                   ...
                                   child: const Text('🔥 DEAL REACHED', style: TextStyle(color: Colors.black, fontSize: 8, fontWeight: FontWeight.w900)),

                                 ),
                              Text('CURRENT', style: TextStyle(color: isDark ? Colors.white38 : Colors.black38, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
                              Text(
                                item.currentPrice != null ? currency.format(item.currentPrice!) : 'TRACKING...',
                                style: TextStyle(
                                  fontWeight: FontWeight.w900,
                                  fontSize: 18,
                                  color: item.currentPrice != null && item.targetPrice != null && item.currentPrice! <= item.targetPrice! 
                                      ? Colors.greenAccent 
                                      : (item.currentPrice == null ? Colors.cyanAccent : Colors.orangeAccent)
                                ),
                              ),
                            ],
                          ),
                ...
                const SizedBox(width: 8),
                    IconButton(
                      icon: Icon(Icons.add_task, color: Theme.of(context).primaryColor, size: 20),
